...
public class CreateByUserCommandValidator : CustomValidator<CreateByUserCommand>
{
    public CreateByUserCommandValidator(IPermissionUnitOfWork permissionUnitOfWork)
    {
